...
const MovieDetailPage = () => {
  ...
  const { updateMovie, deleteMovie, isUpdating, isDeleting } = useMovies();
  ...
  const handleSubmitEditMovie = useCallback(async (formData: UpdateMovieFormData) => {
    if (!id) return;
  ...
  return (
    ...
    <ConfirmDialog
      ...
      message={
        <>
          Are you sure you want to delete <strong>"{transformedMovieData.title}"</strong>?
          <br />
          This action cannot be undone and you will be redirected to the movies list.
        </>
      }
      confirmText="Delete"
      cancelText="Cancel"
